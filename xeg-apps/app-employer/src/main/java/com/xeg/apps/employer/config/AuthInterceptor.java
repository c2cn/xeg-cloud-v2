package com.xeg.apps.employer.config;

import com.xeg.apps.employer.config.annotation.PermissionLogical;
import com.xeg.apps.employer.config.annotation.RequirePermissions;
