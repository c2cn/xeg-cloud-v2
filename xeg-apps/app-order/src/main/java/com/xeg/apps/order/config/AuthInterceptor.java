package com.xeg.apps.order.config;
...
import com.xeg.apps.order.config.annotation.PermissionLogical;
import com.xeg.apps.order.config.annotation.RequirePermissions;
