package com.xeg.apps.worker.config;

import com.xeg.apps.worker.config.annotation.PermissionLogical;
import com.xeg.apps.worker.config.annotation.RequirePermissions;
