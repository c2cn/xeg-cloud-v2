package com.xeg.devops.scheduler.generator;
...
public class CodeGenerator {
    ...
    public static final String PACKAGE = "com.xiaoergekeji.devops.gateway.scheduler.domain";
    public static final String OUTPUT_DIR = "/devops-scheduler/src/main/java";
...
//        gc.setIdType(IdType.ASSIGN_ID);
    ...
    public static void run() {
        ...
        focList.add(new FileOutConfig("templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名
                return projectPath + "/devops-scheduler/src/main/resources/mapper/"
    ...
    private static StrategyConfig getStrategyConfig() {
        ...
        if ("N".equalsIgnoreCase(scanner("是否生成全部表(Y/N)"))) {
            ...
            strategy.setExclude("qrtz_fired_triggers");
            strategy.setExclude("qrtz_paused_trigger_grps");
            strategy.setExclude("qrtz_scheduler_state");
            strategy.setExclude("qrtz_locks");
            strategy.setExclude("qrtz_simple_triggers");
            strategy.setExclude("qrtz_simprop_triggers");
            strategy.setExclude("qrtz_cron_triggers");
            strategy.setExclude("qrtz_blob_triggers");
            strategy.setExclude("qrtz_triggers");
            strategy.setExclude("qrtz_job_details");
            strategy.setExclude("qrtz_calendars");
        }
