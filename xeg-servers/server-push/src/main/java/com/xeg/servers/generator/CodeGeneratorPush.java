 ...
 */
public class CodeGeneratorPush {

    public static final String PACKAGE = "com.xeg.servers.push.domain";

    public static final String PROJECT_DIR = "/xeg-servers/server-push/";
