 ...
 */
public class CodeGeneratorOrder {

    public static final String PACKAGE = "com.xeg.servers.order.domain";

    public static final String PROJECT_DIR = "/xeg-servers/server-order/";
    ...
    public static final String TABLE_PREFIX = "xeg_";
