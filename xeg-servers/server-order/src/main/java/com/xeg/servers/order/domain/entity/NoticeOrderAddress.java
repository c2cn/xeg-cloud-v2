...
/**
	* @author xian
	* @date   2021年11月4日 下午5:35:16
	* @version v1.0.0
	* @Description	短工大厅工作地点和接送地点
	* NoticeOrderAddress.java 
	* Modification History:
	* Date                         Author          Version          Description
	---------------------------------------------------------------------------------*
	* 2021年11月4日 下午5:35:16       xian            v1.0.0           Created
 */
@Data
@EqualsAndHashCode(callSuper = false)
@TableName("bus_notice_order_address")
@ApiModel(value="BusNoticeOrderAddress对象", description="短工大厅工作地点和接送地点")
public class NoticeOrderAddress implements Serializable {
