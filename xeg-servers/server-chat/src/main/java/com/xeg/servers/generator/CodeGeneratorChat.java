 ...
 */
public class CodeGeneratorChat {

    public static final String PACKAGE = "com.xeg.servers.chat.domain";

    public static final String PROJECT_DIR = "/xeg-servers/server-chat/";
