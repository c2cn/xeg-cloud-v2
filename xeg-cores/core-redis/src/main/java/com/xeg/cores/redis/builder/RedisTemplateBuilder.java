package com.xeg.cores.redis.builder;
...
import com.xeg.cores.redis.config.JedisSetting;
...
public class RedisTemplateBuilder {
    ...
    private IRedisBuilder getRedisBuilder() {
        ...
        throw new ServiceException(ThrowCommonException.ANY_ERROR, "错误的redis 配置类型，请检查");
    }
