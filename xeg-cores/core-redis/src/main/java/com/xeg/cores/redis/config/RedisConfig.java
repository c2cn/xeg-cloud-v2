package com.xeg.cores.redis.config;

import java.util.Set;

import com.xeg.cores.redis.builder.RedisTemplateBuilder;
import com.xeg.cores.redis.builder.StringRedisTemplateBuilder;
 ...
 * Redis配置
 * 
 * @author kingapex 2017年8月2日上午11:52:50
 *
