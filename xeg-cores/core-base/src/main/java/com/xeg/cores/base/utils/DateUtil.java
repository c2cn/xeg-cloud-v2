...
public class DateUtil {
    ...
    public static final String ISO_INSTANT = "yyyy-MM-ddTHH:mm:ssZ";
    /**
     * 24小时时间正则表达式
     */
     ...
     * @return timestamp
     */
    public static long getOneDayMinTimestamp(LocalDate date) {
        return localDateTimeToTimestamp(LocalDateTime.of(date, LocalTime.MIN));
    }
     ...
     * @return timestamp
     */
    public static long getOneDayMaxTimestamp(LocalDate date) {
        return localDateTimeToTimestamp(LocalDateTime.of(date, LocalTime.MAX));
    }
    ...
    public static String getLastYearMonth() {
        return LocalDate.now().minusMonths(1).format(DateTimeFormatter.ofPattern(YEAR_MONTH_FORMATTER));
    }
    ...
    public static int getUserAge(String ageStr) {
        return DateUtil.getYearDiff(DateUtil.localDateToDate(DateUtil.parseLocalDate(ageStr, "yyyy-MM-dd")), new Date());
    }
     ...
     * 获取本月第一天00:00:00
     */
    public static long getCurrentMonthFirstDate() {
        //获取当前日期
     ...
     * 获取本月最后一天
     */
    public static long getCurrentMonthLastDate() {
        // 获取当前日期
        Calendar calendar = Calendar.getInstance();
        //
     ...
     * 获取下个月的此时此刻
     */
    public static long getNextCurrentMillisecond() {
        // 获取当前日期
        Calendar calendar = Calendar.getInstance();
        // 下个月今天
        calendar.add(Calendar.MONTH, 1);
     ...
     * @param endLocalDateTime   止日期时间
     */
    public static long intervalSecond(LocalDateTime startLocalDateTime, LocalDateTime endLocalDateTime) {
        return intervalMillis(startLocalDateTime, endLocalDateTime) / 1000;
    }
    ...
    /**
     * 2021-05-28T04:06:02Z 转 Date
     *
     * @param oldDateStr
     * @return
     */
    public static Date isoStringToDate(String oldDateStr) {
     ...
     * 生日格式化
     *
     * @param birth 19960512
     * @return 1996/05/12
     */
    public static String birthFormat(String birth) {
        if (StrUtil.isNotEmpty(birth) && birth.length() == 8) {
