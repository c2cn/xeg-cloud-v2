...
/****
 * @Description 腾讯im 生成 userconfig
 * @Author Zhongkun Zhang
 * @Data create in 2021/5/12 9:46
 * @Version 1.0
 **/
@Component
public class TLSMVSigAPIv2 {

    @Resource
    private TencentCloudConfig tencentCloudConfig;

    public TLSMVSigAPIv2( ) {
    }
    ...
    public long getSdkAppId() {
        return tencentCloudConfig.getSdkMVAppId();
    }
    ...
    private String hmacsha256(String identifier, long currTime, long expire, String base64Userbuf) {
        String contentToBeSigned = "TLS.identifier:" + identifier + "\n"
                + "TLS.sdkappid:" + tencentCloudConfig.getSdkMVAppId() + "\n"
                + "TLS.time:" + currTime + "\n"
                + "TLS.expire:" + expire + "\n";
        ...
        try {
            byte[] byteKey = tencentCloudConfig.getMvKey().getBytes(StandardCharsets.UTF_8);
    ...
    private String genUserSig(String userid, long expire, byte[] userbuf) {
        ...
        sigDoc.set("TLS.sdkappid", tencentCloudConfig.getSdkMVAppId());
    ...
    public byte[] genUserBuf(String account, long dwAuthID, long dwExpTime,
        ...
        //dwSdkAppid
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkMVAppId() & 0xFF000000) >> 24);
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkMVAppId() & 0x00FF0000) >> 16);
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkMVAppId() & 0x0000FF00) >> 8);
        userbuf[offset++] = (byte) (tencentCloudConfig.getSdkMVAppId() & 0x000000FF);
