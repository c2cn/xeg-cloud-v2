 ...
 */
@UtilityClass
public class XegConstant {


    /**
     * 应用版本号
     */
    public static final String XEG_APP_VERSION = "1.0.0-SNAPSHOT";
     ...
     * 微服务之间传递的唯一标识
     */
    public static final String XEG_TRACE_ID = "xeg-trace-id";
     ...
     * 权限认证的排序
     */
    public static final int XEG_UAA_FILTER_ORDER = -200;

    /**
     * 签名排序
     */
    public static final int XEG_SIGN_FILTER_ORDER = -300;
    ...
    public static final String CONFIG_DATA_ID_DYNAMIC_ROUTES = "cloud-devops-gateway.yml";

    public static final String CONFIG_DATA_ID_COMMON = "cloud-url-rule.yml";
