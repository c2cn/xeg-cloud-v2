...
public class TLSSigAPIv2 {
    ...
    public long getSdkAppId() {
        return tencentCloudConfig.getSdkappid();
    }
    ...
    private String hmacsha256(String identifier, long currTime, long expire, String base64Userbuf) {
        String contentToBeSigned = "TLS.identifier:" + identifier + "\n"
                + "TLS.sdkappid:" + tencentCloudConfig.getSdkappid() + "\n"
                + "TLS.time:" + currTime + "\n"
                + "TLS.expire:" + expire + "\n";
        ...
        try {
            byte[] byteKey = tencentCloudConfig.getImKey().getBytes(StandardCharsets.UTF_8);
    ...
    private String genUserSig(String userid, long expire, byte[] userbuf) {
        ...
        sigDoc.set("TLS.sdkappid", tencentCloudConfig.getSdkappid());
    ...
    public byte[] genUserBuf(String account, long dwAuthID, long dwExpTime,
        ...
        //dwSdkAppid
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkappid() & 0xFF000000) >> 24);
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkappid() & 0x00FF0000) >> 16);
        userbuf[offset++] = (byte) ((tencentCloudConfig.getSdkappid() & 0x0000FF00) >> 8);
        userbuf[offset++] = (byte) (tencentCloudConfig.getSdkappid() & 0x000000FF);
